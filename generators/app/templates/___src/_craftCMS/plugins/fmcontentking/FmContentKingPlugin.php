 ...
 *
 * Generating dummy content for modules from json-files
 *
 * --snip--
...
class FmContentKingPlugin extends BasePlugin
{
    /**
    ...
    {
        return Craft::t('Generating dummy content for modules from json-files');
    }
    ...
    {
        return 'https://github.com/witti/fmcontentking/blob/master/README.md';
    }
    ...
    {
        return 'https://raw.githubusercontent.com/witti/fmcontentking/master/releases.json';
    }
    ...
    {
        return 'https://wittistribune.com';
    }
