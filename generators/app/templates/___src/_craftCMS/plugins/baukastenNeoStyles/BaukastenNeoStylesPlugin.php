<?php
/**
 * Baukasten Neo Styles plugin for Craft CMS
 *
 ...
 * @package   baukasten-neo-styles
 * @since     1.0.0
 */

namespace Craft;

class BaukastenNeoStylesPlugin extends BasePlugin
{
    /**
    ...
    {
        return Craft::t('Flat Structure Neo Contentbuilder needs some CSS to work propely, adding this as a Plugin instead of using Custom CSS Plugin');
    }
    ...
    {
        return 'https://github.com/davidhellmann/baukasten-neo-styles/blob/master/README.md';
    }
    ...
    {
        return 'https://raw.githubusercontent.com/davidhellmann/baukasten-neo-styles/master/releases.json';
    }
