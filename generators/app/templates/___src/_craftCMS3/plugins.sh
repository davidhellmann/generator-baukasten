...
echo ''
echo '>>> Installing: CP Clear Cache'
composer require mmikkel/cp-clearcache
echo '--------------------------------------------------'

echo ''
echo '>>> Installing: CP Element Count'
composer require aelvan/craft-cp-element-count
echo '--------------------------------------------------'

echo ''
echo '>>> Installing: CP Field Inspect'
...
echo ''
echo '>>> Installing: Control Panel CSS'
...
echo ''
echo '>>> Installing: Dumper'
composer require studioespresso/craft-dumper
echo '--------------------------------------------------'

echo ''
echo '>>> Installing: Element API'
composer require craftcms/element-api
echo '--------------------------------------------------'

echo ''
echo '>>> Installing: Environment Label'
