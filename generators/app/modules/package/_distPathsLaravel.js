...
function addDistPathsLaravel(files = {}) {
    extend(files.pkg, {
        dist: {
            base: '___dist/',
            markup: '___dist/resources/views/',
            ...
            images: {
                ...
                bitmap: {
                    ...
                    faviconPath: '___dist/public/assets/images/bitmap/favicons/'
                },
                svg: {
...
module.exports = addDistPathsLaravel
